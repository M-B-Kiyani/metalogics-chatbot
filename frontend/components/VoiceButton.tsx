...
const VoiceButton: React.FC<VoiceButtonProps> = ({
  ...
  // Show disabled button if not configured (for better UX)
    ...
    return (
      <div className="flex flex-col items-center gap-2">
        <button
          type="button"
          disabled={true}
          className="relative flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-600 text-white opacity-50 cursor-not-allowed"
          title="Voice integration not configured"
        >
        ...
        <div className="text-xs text-gray-400 max-w-xs text-center">
          Voice integration requires API keys
        </div>
      </div>
    );
  }
